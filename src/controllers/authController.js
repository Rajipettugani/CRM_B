...
export const register = async (req, res) => {
  ...
  if (user) {
    try {
      const mail_configs = {
        ...
        to: email,
        cc: "anilvijayagiri154@gmail.com,ssreenijappuvvula@gmail.com",
  ...
  `,
      ...
      return res
        .status(201)
        .json({ id: user._id, message: "User created and email sent" });
    } catch (error) {
...
export const sendRecoveryEmail = async (req, res) => {
  ...
  try {
    const mail_configs = {
      ...
      html: `<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2"><div style="margin:50px auto;width:70%;padding:20px 0"><div style="border-bottom:1px solid #eee"><a href="" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">SKY CRM</a></div><p style="font-size:1.1em">Hi,</p><p>Use the following OTP to complete your Password Recovery. OTP is valid for 5 minutes</p><h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">${OTP}</h2><p style="font-size:0.9em;">Regards,<br />SKY CRM</p><hr style="border:none;border-top:1px solid #eee" /><div style="float:right;padding:8px 0;color:#aaa;font-size:0.8em;line-height:1;font-weight:300"><p>SKY CRM Inc</p></div></div></div>`,
    };
    await transporter.sendMail(mail_configs);
